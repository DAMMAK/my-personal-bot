    ...
    request({
        ...
        if (!error && response.statusCode == 200) {
            ...
            if (user.first_name) {
                ...
                sendTextMessage(userId, 'Hola ' + user.first_name + ', ¡me alegro de verte por aquí! Soy Mediakín, el bot de MEDIAKIA y estoy aquí para ayudarte. ¿Puedo hacer algo por ti?');
            } else {
